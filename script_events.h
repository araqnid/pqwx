...
// generated by documents notebook when last script is closed
  DECLARE_EVENT_TYPE(PQWX_NoDocumentSelected, -1)
...
#define PQWX_NO_DOCUMENT_SELECTED(id, fn) EVT_COMMAND(id, PQWX_NoDocumentSelected, fn)
